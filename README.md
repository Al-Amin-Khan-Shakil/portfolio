...
- [Live Demo Link](https://al-amin-khan-shakil.github.io/portfolio/)
...
```sh
  cd my-folder
  git clone git@github.com:Al-Amin-Khan-Shakil/portfolio.git
```
...
Feel free to check the <a href="https://github.com/Al-Amin-Khan-Shakil/portfolio/issues">issues page.</a>
